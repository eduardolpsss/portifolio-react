            ...
            <div className="row">
                <div className="col">
                    <div className="card text-white backgroundCard">
                        ...
                        <div className="card-body">
                            <h5 className="text-center card-title">Java and Vue.js RESTful API</h5>
                            <div className="text-center">
                ...
                <div className="col">
                    <div className="card text-white backgroundCard">
                        ...
                        <div className="card-body">
                            <h5 className="text-center card-title">RESTful API Using JSON Server and React</h5>
                            <div className="text-center">
                                <img className="img-fluid float-center" src="/images/repoImgs/reactWithJsonServer.png" alt="" width={255} height={255}/>
                            </div>
                            <p className="card-text paragrafoCard">RESTful API developed with React.js on the front-end and a JSON Server back-end.</p>
                            <div className="text-center">
            ...
            <div className="row">
                <div className="col">
                    <div className="card text-white backgroundCard">
                        ...
                        <div className="card-body">
                            <h5 className="text-center card-title">Node.js RESTful API</h5>
                            <div className="text-center">
